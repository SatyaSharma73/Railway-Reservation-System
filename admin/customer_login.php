...
$query="insert into customer set name='".$_POST['name']."',email='".$_POST['email']."',password='".$_POST['password']."' ,p_image='".$file."'";
...
<title>Welcome to Indian Railway Passenger Reservation Enquiry</title>
  ...
  <body>
    ...
    <div class="container" id="container">
        ...
        <form method="POST" action="customer_login_do.php" enctype="multipart/form-data">
          <h1>Sign In</h1>
